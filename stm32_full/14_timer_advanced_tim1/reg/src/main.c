...
static void tim1_ch1_pwm_init(void)
{
    ...
    GPIOA->CRH |= GPIO_CRH_MODE8_1 | GPIO_CRH_CNF8_1; /* PA8 = TIM1_CH1 复用推挽输出。 */
    TIM1->PSC = 72U - 1U;
    TIM1->ARR = 1000U - 1U;
    TIM1->CCR1 = 300U;
    TIM1->CCMR1 = TIM_CCMR1_OC1M_2 | TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1PE;
    TIM1->CCER = TIM_CCER_CC1E;
    TIM1->BDTR = TIM_BDTR_MOE; /* 高级定时器必须打开主输出使能，否则通道不会真正到引脚。 */
    TIM1->CR1 = TIM_CR1_ARPE | TIM_CR1_CEN;
    TIM1->EGR = TIM_EGR_UG;
}
int main(void){ system_clock_72mhz_init(); pc13_led_init(); tim1_ch1_pwm_init(); while(1){ pc13_toggle(); delay_cycles(3600000U); } }
